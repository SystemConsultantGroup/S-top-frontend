...
// function reloadyoutube(v: string){
//   const y = document.getElementById("youtubeloader")
//   const rec = /^((?:https?:)?\/\/)?((?:www|m)\.)?((?:youtube(-nocookie)?\.com|youtu.be))(\/(?:[\w\-]+\?v=|embed\/|live\/|v\/)?)([\w\-]+)(\S+)?$/g
//   const k = rec.exec(v)
//   const b = document.getElementsByName("youtubeurl")[0]
//   const t = document.getElementById("submit")
//   t.hidden = !Boolean(v.match(rec))
//   if (Boolean(b.value)){
//       id = k[6]
//       y.src = "https://www.youtube.com/embed/" + id
//       b.value = "https://www.youtube.com/watch?v=" + id
//   } else {
//       y.src = ""
//       b.value = ""
//   }
//   y.hidden = !Boolean(b.value)
// }
